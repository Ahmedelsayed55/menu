...
const Cake26 = ({id}) => {
 ...
 <div className='container mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5' id={id}>
     ...
     {prduct.map((item)=>{
      return(
        <div key={item.id} className="rounded-2xl shadow-blue-200 shadow-sm p-5 flex flex-col gap-3 items-center transition hover:scale-110 bg-gray-100 active:scale-110 focus:scale-110" >
